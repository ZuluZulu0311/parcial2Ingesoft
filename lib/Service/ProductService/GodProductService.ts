...
import { ConcreteProductBuilder } from '@/lib/ProductBuilder/ConcreteProductBuilder';
import { ProductDirector } from '@/lib/ProductBuilder/ProductDirector';
import { Product } from '@/lib/Models/Products';

export class GodProductService{
    async crearProductoConTodo(
        ...
        // Construye el prooducto haciendo uso del builder
